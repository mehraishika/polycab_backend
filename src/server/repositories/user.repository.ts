...
export class UserRepository {
	...
	async listByRole(roleType: UserRoleType, filters: UserListQueryInput): Promise<UserListResult> {
	...
	async getDeviceCountsByAccounts(accounts: string[]): Promise<Map<string, number>> {
